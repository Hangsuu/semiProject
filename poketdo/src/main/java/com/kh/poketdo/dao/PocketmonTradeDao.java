...
public class PocketmonTradeDao {
  ...
  public void insert(PocketmonTradeDto pocketmonTradeDto) {
    String sql = "insert into pocketmon_trade (pocketmon_trade_no, allboard_no, pocketmon_trade_title, pocketmon_trade_writer, pocketmon_trade_written_time, pocketmon_trade_content, pocketmon_trade_trade_time, pocketmon_trade_complete, pocketmon_trade_read, pocketmon_trade_reply, pocketmon_trade_like) values (?, ?, ?, ?, sysdate, ?, ?, 0, 0, 0, 0)";
    Object[] param = {
