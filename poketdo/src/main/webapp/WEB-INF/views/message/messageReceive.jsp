...
<section class="flex-row-justify-center">
  ...
  <article class="container-800 mg-0">
    <div class="row mb-40">
        <h1>받은 쪽지함 <a class="deco-none message-not-read-cnt" href="/message/receive?mode=new" style="color:#ffd400">${notReadCnt}</a>/<a class="deco-none message-receive-cnt" style="color:black" href="/message/receive"></a></h1>
    </div>
    <div class="row flex">
