...
<script src="${pageContext.request.contextPath}/static/js/pocket-edit.js"></script>
								...
								<c:forEach items="${typeList}" var="type">
									<c:choose>
										<c:when test="${type.pocketTypeName eq typeJoinName}">
											<option value="${type.pocketTypeNo}" selected>${type.pocketTypeNo}.${type.pocketTypeName}</option>
										</c:when>
										<c:otherwise>
											<option value="${type.pocketTypeNo}">${type.pocketTypeNo}.${type.pocketTypeName}</option>
										</c:otherwise>
									</c:choose>
								</c:forEach>
							</select>
