          ...
          <div style="display: inline-block; padding: 10px">
            <c:choose>
              <c:when test="${empty sessionScope.memberId}">
                <!-- css:commons, base -->
                <a href="/member/login" class="link center"
                  ><span class="header-menu">로그인</span></a
                >
              </c:when>
              <c:otherwise>
                <a href="/member/logout" class="link center"
                  ><span class="header-menu">로그아웃</span></a
                >
              </c:otherwise>
            </c:choose>
          </div>
          <div style="display: inline-block">
            <a href="/seal/list" class="link center"
              ><span class="header-menu">인장뽑기</span></a
            >
          </div>
          <div style="display: inline-block">
            <c:if test="${sessionScope.memberId != null}">
              <a href="/message/receive" class="link center"
                ><span class="header-menu">쪽지</span></a
              >
            </c:if>
          </div>
          <div style="display: inline-block">
            <c:if test="${sessionScope.memberLevel == '마스터'}">
              <a href="/admin/adminCheck" class="link center"
                ><span class="header-menu">관리 페이지</span></a
              >
            </c:if>
          </div>
          <div style="display: inline-block" class="me-30">
            <a href="/member/mypage" class="link center"
              ><span class="header-menu">마이페이지</span></a
            >
          </div>
        </div>
        <%-- base.css --%>
              ...
              <div class="nav-bar flex-box align-center">
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      <a href="/auction/list?page=1"
                        ><span>굿즈 경매 게시판</span></a
                      >
                    </div>
                    <div>
                      <a href="/combination/list?page=1"
                        ><span>공략 게시판</span></a
                      >
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      <a href="/combination/simulator?page=1&tagList="
                        ><span>조합시뮬레이터</span></a
                      >
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div>
                      <a href="/pocketmonTrade"
                        ><span>포켓몬교환 게시판</span></a
                      >
                    </div>
                  </div>
                </div>
